...
void			ft_lstdelone(tetri_list **alst, void (*del)(void *, size_t));
void			ft_lstdel(tetri_list **alst, void (*del)(void *, size_t));
void			ft_lstadd(tetri_list **alst, tetri_list *new);
void			ft_lstiter(tetri_list *lst, void (*f)(tetri_list *elem));
tetri_list			*ft_lstmap(tetri_list *lst, tetri_list *(*f)(tetri_list *elem));
